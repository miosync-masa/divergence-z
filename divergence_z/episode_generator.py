...
If you cannot verify exact wording, use this format:
  - quote: "[unverified] Approximate: オカリン、もういいんだよ"
...
Episode Memory files contain canonical_quotes — actual dialogue from specific scenes.
...
1. "{name} {source} wiki plot episodes" — story events and episode numbers
2. "{name} {source} 名言 名シーン セリフ" — iconic quotes with scene context
3. "{name} {source} character arc timeline" — character development and changes{sequel_instruction}
